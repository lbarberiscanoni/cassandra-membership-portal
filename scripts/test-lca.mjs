...
console.log("\n3. Window: post Mon 2026-03-02, no holidays");
const wA = computeWindow("2026-03-02");
eq("remainsThrough = Fri 2026-03-13 (10th business day)", wA.remainsThrough, "2026-03-13");
eq("firstBusinessDay = posting date", wA.firstBusinessDay, "2026-03-02");
eq("earliestRemoval = 2026-03-14", wA.earliestRemoval, "2026-03-14");
eq("calendarDays = 12", wA.calendarDays, 12);
...
eq("remainsThrough extended to Mon 2026-06-01", wB.remainsThrough, "2026-06-01");
eq("Memorial Day counted as the extension", wB.holidaysInWindow, [
  { date: "2026-05-25", name: "Memorial Day" },
]);
eq("calendarDays = 15", wB.calendarDays, 15);
...
eq("remainsThrough = Fri 2026-03-20", wC.remainsThrough, "2026-03-20");
...
eq("remainsThrough = Mon 2026-07-13", wD.remainsThrough, "2026-07-13");
